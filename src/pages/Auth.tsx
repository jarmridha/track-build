      ...
      <div className="hidden lg:flex relative items-center justify-center p-12 text-primary-foreground"
        ...
        <div className="max-w-md space-y-6">
          <div className="flex items-center gap-3">
            ...
            <div className="text-2xl font-bold tracking-tight">SiteTrack</div>
          </div>
          <h1 className="text-4xl font-bold leading-tight">
            Manage every site, every update, every milestone.
          </h1>
          <p className="text-primary-foreground/80 text-lg">
            Built for engineers, supervisors, and admins to track construction projects from foundation to handover.
          </p>
        </div>
      </div>

      <div className="flex items-center justify-center p-6 lg:p-12 bg-background">
        <Card className="w-full max-w-md p-6 lg:p-8 shadow-[var(--shadow-card)]">
          <div className="lg:hidden flex items-center gap-2 mb-6">
            <div className="flex h-9 w-9 items-center justify-center rounded-lg bg-primary">
              <HardHat className="h-5 w-5 text-primary-foreground" />
            </div>
            <span className="font-bold text-lg">SiteTrack</span>
          </div>
            ...
            <TabsContent value="signin">
              <form onSubmit={handleSignIn} className="space-y-3">
                <div>
                  ...
                  <Input id="si-email" type="email" required value={signInForm.email}
                    onChange={e => setSignInForm({ ...signInForm, email: e.target.value })} />
                </div>
                <div>
                  <Label htmlFor="si-pwd">Password</Label>
                  <Input id="si-pwd" type="password" required value={signInForm.password}
            ...
            <TabsContent value="signup">
              <form onSubmit={handleSignUp} className="space-y-3">
                <div>
                  ...
                  <Input id="su-name" required value={signUpForm.name}
